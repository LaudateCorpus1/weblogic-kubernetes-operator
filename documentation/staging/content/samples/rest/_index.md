...
more information, see [Updating operator external certificates]({{<relref "/userguide/managing-operators/the-rest-certificates#updating-operator-external-certificates">}}).
